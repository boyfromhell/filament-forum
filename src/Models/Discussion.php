...
class Discussion extends Model
{
    ...
    {
        return $this->belongsToMany(Tag::class, 'forum_discussion_tags', 'discussion_id', 'tag_id');
    }
    ...
    {
        return $this->belongsToMany(User::class, 'forum_followers', 'discussion_id', 'user_id')->withPivot('type');
    }
