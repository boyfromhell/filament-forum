...
class DiscussionDetails extends Component implements HasForms
{
        ...
        Notification::make()
            ...
            ->actions([
                Action::make('confirm')
                    ...
                    ->button()
                    ->close()
                    ->dispatch('doDeleteComment', ['comment' => $comment]),
    ...
    public function saveComment(): void
    {
        ...
        $this->comment->save();
        $this->dispatch('commentSaved');
        Notification::make()->success()->title('Comment successfully saved.')->send();
