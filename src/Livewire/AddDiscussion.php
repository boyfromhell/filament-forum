...
class AddDiscussion extends Component implements HasForms
{
    ...
    {
        return view('filament-forum::livewire.add-discussion');
    }
    ...
    public function submit(): void
    {
        ...
        if ($this->discussion) {
            ...
            DiscussionTag::query()->where('discussion_id', $this->discussion->id)->delete();
            $update = true;
